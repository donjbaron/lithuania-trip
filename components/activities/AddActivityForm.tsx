  ...
  return (
    <form ref={formRef} action={handleSubmit} className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="sm:col-span-2">
          <label className="block text-xs font-medium text-gray-500 mb-1">Address <span className="text-gray-300">(optional — auto-filled by search)</span></label>
          <input
            type="text"
            name="address"
            placeholder="Street address or landmark"
            defaultValue={filled.address ?? ""}
            key={filled.address ?? "addr"}
            className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-400"
          />
        </div>
